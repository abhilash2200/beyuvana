 ...
 */
export function isPaymentApiResponse(
  value: unknown,
): value is PaymentApiResponse {
 ...
 */
export function isPaymentResponseData(
  value: unknown,
): value is PaymentResponseData {
  if (!value || typeof value !== "object") {
    return false;
  }
  const obj = value as Record<string, unknown>;
 ...
 */
export function isPaymentResponseItem(
  value: unknown,
): value is PaymentResponseItem {
  if (!value || typeof value !== "object") {
    return false;
  }
  const obj = value as Record<string, unknown>;
