...
export const notifications = {
  ...
  auth: {
    ...
    registerSuccess: (name: string) =>
      toast.success(
        `Welcome to BEYUVANA, ${name}! Your account has been created successfully.`,
      ),
...
export const handleApiError = (error: unknown) => {
  ...
  import("@/lib/error-handling")
    .then(({ handleApiError: handleApiErrorNew }) => {
