...
const DetailsOfGreenCollagen = lazy(() => import("./DetailsOfGreenCollagen"));
        ...
        <>
            ...
            <div className="container mx-auto px-4">
                        ...
                        <div className="relative px-4">
                            <div className="flex flex-wrap">
                                <div className="w-full md:w-[50%] md:py-26 md:pl-10">
                                    <div className="mb-6">
                                        <p className="border rounded-[8px] px-4 py-2 text-[15px] inline-flex">
                                            10 ACTIONS. 1 SMART SACHET
                                        </p>
                                    </div>
                                    <h2 className="font-[Grafiels] md:text-[25px] text-[18px] text-[#1A2819] leading-tight md:leading-relaxed mb-3 max-w-[80%]">
                                        A Premium Collagen Builder Powered by 21 Synergistic
                                        Plant-Based Actives
                                    </h2>
                                </div>
                                <div className="w-full md:w-[50%] hidden md:block">
                                    <div className="absolute bottom-0.5 right-0">
                                        <Image
                                            src="/assets/img/product-details/action-green.webp"
                                            alt="action"
                                            width={448}
                                            height={368}
                                            className="h-auto"
                ...
                <div className="md:py-10 py-6">
                        ...
                        <div className="w-full md:w-[48%]">
                            ...
                            <ul>
                                {benefits.map((item, index) => (
                                    ...
                                    >
                                        <FaRegCheckSquare className="text-[#0C4B33] w-5 h-5 font-normal" />{" "}
                                        {item.text}
                                    </li>
                                ))}
                            </ul>
                    ...
                    <div className="md:text-center text-left py-6">
                        <p className="leading-relaxed font-normal text-[15px] ">
                            This transformation is powered by a synergy of botanicals,
                            antioxidants, and Ayurvedic adaptogens — uniting nature and
                            science for timeless, radiant skin.{" "}
                        </p>
                    </div>
                </div>
                ...
                <div className="md:py-10 py-6">
                    <div className="flex flex-wrap items-center gap-y-10 justify-between">
                        <div className="w-full md:w-[40%]">
                            <HeaderText
                                textalign="text-left"
                                heading="Powered by Research-Backed Ingredients in BEYUVANA™ PREMIUM COLLAGEN BUILDER"
                                ...
                                {stats.map((item, index) => (
                                    <div key={index} className="w-[45%] md:w-[47%]">
                                        <div className="flex flex-col items-center gap-y-2 px-4 py-6 bg-[#EDFFF0] hover:bg-[#0C4B33] transition-colors group rounded-[20px]">
                                            <h2 className="text-[#0C4B33] font-[Grafiels] md:text-[30px] text-[20px] leading-tight group-hover:text-[#EDFFF0] transition-colors">
                                                {item.percent}
                                            </h2>
                ...
                <Suspense fallback={<SectionLoader />}>
                    <div className="md:py-10 py-6">
                        <HeaderText
                            textalign="md:text-center text-left"
                            heading="Why the BEYUVANA™ PREMIUM COLLAGEN BUILDER Works"
                            textcolor="text-[#1A2819]"
                        />
                ...
                <Suspense fallback={<SectionLoader />}>
                    <div className="md:py-10 py-6">
                        <div className="flex flex-wrap items-start justify-between">
                            <div className="w-full md:w-[48%]">
                                <Image
                                    src="/assets/img/product-details/green-288484.webp"
                                    width={772}
                                    height={684}
                                    alt="detail info"
                ...
                <Suspense fallback={<SectionLoader />}>
                    <div className="md:py-10 py-6 bg-[#F8FFF9] rounded-[20px]">
                        <HeaderText
                            textalign="md:text-center text-left"
                            heading="Who Is BEYUVANA™ Premium Collagen Builder Made For?"
                            textcolor="text-[#1A2819]"
                        />
            ...
            <Suspense fallback={<SectionLoader />}>
                <div className="md:py-10 py-6">
                    ...
                    <p className="md:text-center text-left mb-4 md:w-[90%] w-full mx-auto leading-tight px-4">
                ...
                <div className="md:py-10 py-6">
                    <div className="container mx-auto px-4">
                        <HeaderText
                            ...
                            heading="BEYUVANA™ PREMIUM COLLAGEN BUILDER VS OTHER PRODUCTS"
                            textcolor="text-[#1A2819]"
                        />
