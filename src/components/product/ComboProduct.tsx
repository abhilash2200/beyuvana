            ...
            <div className="flex flex-wrap justify-between items-center">
              ...
              <div className="w-full md:w-[35%]">
                <div className="p-6 flex items-center justify-center rounded-[10px] bg-[#FAFAFA]">
                  <Image
                    src={
                      product.image || "/assets/img/collagen-green-product.png"
                    }
                    width={332}
                    height={382}
              ...
              <div className="w-full md:w-[65%]">
                <div className="flex flex-col">
                  <h2 className="text-[#1A2819] font-[Grafiels] text-[25px] leading-tight mb-4">
                    {product.name}
                  </h2>
                  <div>
                  ...
                  {product.product_description && (
                    <p className="text-[15px] mb-3 font-light">
                      {product.product_description}
                    </p>
                  )}
