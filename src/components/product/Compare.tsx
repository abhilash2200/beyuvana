        ...
        {slides.map((slide) => (
          <SplideSlide key={slide.id}>
            <div className="flex flex-col items-center text-left">
              ...
              <div className="py-6">
                <h2
                  className="font-[Grafiels] md:text-[25px] text-[18px] leading-tight mb-4"
                  style={{ color: slide.headingColor || containerHeading }}
                >
                  {slide.title}
                </h2>
                <p
                  className="mb-4 text-[15px] font-light"
                  style={{ color: slide.paraColor || containerPara }}
                >
                  {slide.desc}
                </p>
