...
const faqData: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Yes, they are formulated with high safety standards using clinically tested ingredients.",
  },
  {
    id: "item-4",
      ...
      >
        {faqData.map((item) => (
          <AccordionItem key={item.id} value={item.id}>
            <AccordionTrigger className="flex justify-between items-center bg-[#1F1F1F] text-white px-5 py-3 hover:bg-black hover:cursor-pointer transition-colors duration-300 no-underline hover:no-underline">
