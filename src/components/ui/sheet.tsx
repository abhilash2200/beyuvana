...
// Portal wrapper for the sheet content
...
// Content of the sheet (sliding panel)
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "bg-white data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-[1001] flex flex-col gap-4 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 overflow-y-auto",
          side === "right" &&
      ...
      >
        {children}
        <SheetClose asChild>
          <button className="absolute top-4 right-4 rounded-sm p-1 hover:bg-gray-200">
