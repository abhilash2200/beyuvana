...
const links = [
  { label: "Home", href: "/", icon: <RiHome2Line className="text-lg" /> },
  {
    label: "About Us",
    href: "/about-us",
    icon: <RiInformationLine className="text-lg" />,
  },
  {
    label: "Product",
    href: "/product",
    icon: <RiShoppingBag3Line className="text-lg" />,
  },
  {
    label: "Contact",
    href: "/contact",
    icon: <RiPhoneLine className="text-lg" />,
  },
];
  ...
  return (
    <div className="sticky top-0 z-50 w-full bg-white px-3 py-2 flex items-center justify-between">
      <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
        ...
        <SheetContent
          side="left"
          className="flex flex-col px-6 py-6 h-full justify-between"
        >
          <div>
                  ...
                  <Dialog open={isLoginOpen} onOpenChange={setIsLoginOpen}>
                    ...
                    <DialogContent className="bg-[#F4FFF9] border border-[#1E2C1E] text-black rounded-2xl w-[90%] max-w-[800px]">
                      <DialogHeader>
                        <VisuallyHidden>
                          <DialogTitle>
                            {loginStep === "otp" ? "Verify OTP" : "Login"}
                          </DialogTitle>
                        </VisuallyHidden>
                      </DialogHeader>
