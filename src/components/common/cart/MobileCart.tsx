          ...
          {cartItems.length > 0 && (
            <div className="bg-[#122014] p-2 text-xs text-center mx-4 mb-2 rounded-lg">
              <p className="text-white">
                Get freebies worth up to{" "}
                <span className="font-bold text-green-600">₹500</span> & up to{" "}
                <span className="font-bold text-green-600">₹150</span> off on
                all prepaid orders
              </p>
            </div>
          )}
        ...
        {loading ? (
          ...
          <>
            <div className="flex-1 overflow-y-auto overflow-x-visible px-3 py-2 space-y-3">
              ...
              <div className="space-y-3">
                {cartItems.map((item, index) => (
                  <div
                    ...
                    className="bg-[#F2F9F3] rounded-xl p-3 border border-gray-100"
                  >
                          ...
                          {item.mrp_price && item.discount_percent && (
                            <>
                              ...
                              <p className="text-[10px] text-[#747474]">
                                ...
                                <span className="text-[#057A37] ml-1">
              ...
              <div className="mt-2">
                <h4 className="text-[14px] font-medium text-gray-800 mb-3">
                  Payment Method
                </h4>
                ...
                {selectedPayment === "prepaid" && (
                  <div className="flex justify-center">
                    <Image
                      src="/assets/img/prepaid-image.png"
                      alt="Prepaid"
                      width={350}
                      height={60}
                ...
                {selectedPayment === "cod" && (
                  <div className="flex justify-center">
                    <Image
                      src="/assets/img/postpaid-image.png"
                      alt="COD"
                      width={350}
                      height={60}
                      className="rounded-lg"
