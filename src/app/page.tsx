        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col justify-center items-center text-center">
            <HeaderText
              ...
              heading="About Beyuvana"
              textcolor="text-[#1A2819]"
            />
            <h4 className="text-[#3B3B3B] font-medium md:text-[20px] text-[17px] mb-2">
              Nourishment That Goes Deeper Than Skin.
            </h4>
            <p className="w-full md:max-w-[1200px] font-light text-[15px] md:text-[16px]">
              At BEYUVANA™, we create plant-powered wellness formulations backed
              by modern science, crafted with clinically researched ingredients,
              lab-tested for safety, and made 100% vegetarian—so you always know
          ...
          <div className="flex flex-wrap gap-x-2 items-center justify-between">
            ...
            <div className="w-fill md:w-[68%]">
              <div className="flex flex-col gap-y-4">
                <HeaderText
                  textalign="text-left"
                  heading="BEYUVANA™ 90-Day Money-Back Guarantee"
                  textcolor="text-[#057A37]"
                />
