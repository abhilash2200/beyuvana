      ...
      <section className="md:py-10 py-6">
        <div className="container mx-auto px-4">
          <div className="flex flex-col justify-center items-center text-center">
            ...
            <p className="w-full md:max-w-[1200px] font-light text-[15px] md:text-[16px]">At BEYUVANA™, we create plant-powered wellness formulations backed by modern science, crafted with clinically researched ingredients, lab-tested for safety, and made 100% vegetarian—so you always know exactly what you&apos;re putting into your body. </p>
          </div>
        </div>
      </section>
