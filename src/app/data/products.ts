...
export const products: Product[] = [
    ...
    benefits: [
      {
        ...
        text: "Boosts Skin Elasticity by up to 53%",
      },
      {
        img: "/assets/img/c2.png",
        text: "Fast Absorption with Bioavailable Plant Actives",
      },
      {
        img: "/assets/img/c3.png",
        text: "Reduces Visible Wrinkles & Fine Lines by 30%",
      },
      {
        img: "/assets/img/c4.png",
        text: "Promotes Hair Strength & Growth Naturally",
      },
    ],
  ...
  },
  {
    ...
    descriptiontext:
      "Glutathione and clinically studied Vitamin C, it works deep at the cellular level to visibly reduce dark spots, pigmentation, and dullness — revealing a brighter, more even-toned complexion. ",
