...
export const fallbackProducts: Product[] = [
  ...
  },
  {
    ...
    tagline: "Aging is Natural — Radiance is a Choice",
    description: [
      "Glow Essence is an advanced, 100% vegetarian, skin-nourishing formula enriched with 18 synergistic plant based actives, designed to unlock visible clarity and radiance from within. Infused with 4X Liposomal Glutathione and clinically studied Vitamin C, it works deep at the cellular level to visibly reduce dark spots, pigmentation, and dullness — revealing a brighter, more even-toned complexion. This potent blend of antioxidants, skin-repair nutrients, and gut-supporting botanicals helps restore internal balance and elevates skin vitality.",
      "Key actives like Licorice, Grape Seed Extract, and Green Tea (EGCG) gently fade blemishes while promoting a luminous, youthful glow. Hyaluronic Acid, Pomegranate, and Vitamin E replenish hydration and reinforce the skin barrier for smooth, supple, radiant skin. Adaptogenic herbs including Amla, Shatavari, and Ashwagandha calm inflammation, reduce stress-related breakouts, and support the gut-skin axis for long-term clarity and balance. ",
      "Naturally sweetened with Stevia and crafted without gelatin, sugar, or synthetic additives — Glow Essence delivers clean, conscious, high-performance skin nutrition. Expect visible results in just 6–8 weeks. Discover the science of radiance and glow from within — naturally, powerfully, and effectively.  ",
    ],
    certificateImg: "/assets/img/product-details/certificate.png",
    certificateImages: [
