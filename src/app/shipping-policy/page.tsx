...
const Page = () => {
    return (
        <div className="max-w-4xl mx-auto px-4 py-10 text-[#1A2819] leading-relaxed">
            ...
            <p className="mt-6">
                At <strong>BEYUVANA™</strong>, we ensure your beauty and wellness journey starts smoothly and safely. Our supplements, enriched with plant-based actives and lab-tested ingredients, are shipped swiftly and securely to your doorstep.
            </p>
