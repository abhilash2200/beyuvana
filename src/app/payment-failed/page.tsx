      ...
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="bg-white rounded-[20px] p-6 md:p-8 mb-8 shadow-sm border border-gray-100">
          <p className="text-[#222222] font-light md:text-[16px] text-[15px] mb-6 leading-relaxed">
            Your payment could not be completed. This could be due to various
            reasons such as insufficient funds, incorrect card details, or
            network issues. Please try again or use a different payment method.
          </p>
            ...
            <div className="flex items-start gap-4 p-4 bg-red-50 rounded-[10px] border border-red-100">
              ...
              <div>
                ...
                <p className="text-[#3B3B3B] font-light text-[14px]">
                  Your payment could not be completed. The order has been
                  automatically cancelled and no amount has been deducted from
                  your account. You can try placing the order again.
                </p>
              </div>
            </div>
